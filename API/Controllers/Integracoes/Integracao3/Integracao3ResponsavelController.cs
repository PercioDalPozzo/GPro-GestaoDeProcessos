...
{
    [ApiController]
    [Route("Integracao3Responsavel")]
    public class Integracao3ResponsavelController : Controller
    {
        private readonly IAplicResponsavel _aplicResponsavel;


        public Integracao3ResponsavelController(IAplicResponsavel aplicResponsavel)
        {
