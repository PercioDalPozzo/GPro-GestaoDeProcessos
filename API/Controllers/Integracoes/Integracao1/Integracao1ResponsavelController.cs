...
{
    [ApiController]
    [Route("Integracao1Responsavel")]
    public class Integracao1ResponsavelController : Controller
    {
        private readonly IAplicResponsavel _aplicResponsavel;


        public Integracao1ResponsavelController(IAplicResponsavel aplicResponsavel)
        {
