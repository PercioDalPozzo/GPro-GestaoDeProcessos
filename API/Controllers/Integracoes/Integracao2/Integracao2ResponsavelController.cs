...
{
    [ApiController]
    [Route("Integracao2Responsavel")]
    public class Integracao2ResponsavelController : Controller
    {
        private readonly IAplicResponsavel _aplicResponsavel;


        public Integracao2ResponsavelController(IAplicResponsavel aplicResponsavel)
        {
